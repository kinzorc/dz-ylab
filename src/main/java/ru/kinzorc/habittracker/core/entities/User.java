...
public class User {
     ...
     * <p>
     * При создании пользователя автоматически генерируется уникальный идентификатор (UUID), устанавливается статус действия аккаунта active,
     ...
     * <p>
     * Примечание: статус {@code Registered} означает, что пользователь зарегистрировался, но еще не активировал учетную запись.
     * </p>
     *
     * @return статус учетной записи пользователя (registered/active/blocked)
     */
     ...
     * </p>
     *
     * @param userStatusAccount новый статус учетной записи (registered/active/blocked)
     */
     ...
     * <p>
     * Включает информацию об имени, email, роли и статусе пользователя и его аккаунта.
     * </p>
     *
