...
public class UserService {
    ...
    public void setUserData(User user, UserData param, String value) {
        switch (param) {
    ...
    public User getUserFromName(String name) {
        return HandlerConstants.USERS.values().stream().filter(user -> user..equals(name)).findFirst().orElse(null);
    }
