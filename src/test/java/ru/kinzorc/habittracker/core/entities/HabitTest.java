...
class HabitTest {
    ...
    void setUp() {
        habit = new Habit(1, "Morning Run", "Run every day", HabitFrequency.DAILY, LocalDate.now(), HabitExecutionPeriod.MONTH);
    }

    @Test
    @DisplayName("Проверка установки и получения имени привычки")
    ...
    @Test
    @DisplayName("Проверка установки и получения описания привычки")
    ...
    @Test
    @DisplayName("Проверка установки и получения частоты выполнения привычки")
    ...
    @Test
    @DisplayName("Проверка установки и получения периода выполнения привычки")
    ...
    @Test
    @DisplayName("Проверка установки и получения даты начала выполнения")
    ...
    @Test
    @DisplayName("Проверка вычисления и установки даты окончания выполнения")
    ...
    @Test
    @DisplayName("Проверка установки и получения статуса привычки")
    ...
    @Test
    @DisplayName("Проверка метода equals для привычек с одинаковым id")
    void testEquals() {
        Habit anotherHabit = new Habit(1, "Evening Walk", "Walk every evening", HabitFrequency.WEEKLY, LocalDate.now(), HabitExecutionPeriod.YEAR);
    ...
    @Test
    @DisplayName("Проверка строкового представления объекта привычки")
    void testToString() {
